...
Usage:
  ...
  python3 fyp/dash_scripts/schedule_experiments.py fyp/dash_experiments/experiments.txt --commands
"""
...
def main() -> None:
    ...
    ap.add_argument("experiments_file", nargs="?",
                    default="fyp/dash_experiments/experiments.txt")
    ...
    runner = "bash fyp/dash_scripts/run_experiments.sh"
    for i, wave in enumerate(waves, 1):
        print(f"# Wave {i}")
        for idx in wave:
