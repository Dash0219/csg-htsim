...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-file",
        default="fyp/dash_dataset/mawi/200803180000.dump.txt",
        help="MAWI dump text input (default: %(default)s)",
    )
    parser.add_argument(
        "--split-dir",
        default="fyp/dash_dataset/mawi/mawi_sinks_top8_prefix16",
...
def main() -> None:
    ...
    if not args.skip_plots:
        plot_out = Path("fyp/dash_results/mawi/flow_size/plots")
        plot_cmd = [
            py,
