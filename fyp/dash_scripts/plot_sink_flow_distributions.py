...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(default: fyp/dash_results/imc/<dataset>/flow_size/plots inferred from --split-dir)."
        ),
    )
    parser.add_argument(
        "--prefix",
...
def main() -> None:
    ...
    out_dir = args.out_dir or f"fyp/dash_results/imc/{infer_imc_dataset(split_dir)}/flow_size/plots"
