...
print_usage() {
  cat <<'EOF'
Usage:
  bash fyp/dash_scripts/run_plot_flow_distribution_mawi.sh [options]

Options:
  -s, --split-dir DIR        Input split directory (default: fyp/dash_dataset/mawi/mawi_sinks_top8_prefix16)
  -o, --out-dir DIR          Output directory (default: fyp/dash_results/mawi/flow_size/plots)
...
OUT_DIR="${OUT_DIR:-fyp/dash_results/mawi/flow_size/plots}"
