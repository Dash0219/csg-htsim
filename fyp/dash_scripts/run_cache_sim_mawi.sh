...
SPLIT_DIR="${1:-fyp/dash_dataset/mawi/mawi_sinks_top8_prefix16}"
OUT_DIR="${2:-fyp/dash_results/mawi/cache_sim/source_seen}"
...
plot_cmd=(python3 fyp/dash_scripts/plot_cache_capacity.py "$CAPACITY_CSV" --out-dir "$CAPACITY_PLOTS_DIR" --prefix "mawi_source_seen_capacity" --min-capacity "$CAPACITY_PLOT_MIN_CAPACITY")
