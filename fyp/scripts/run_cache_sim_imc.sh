...
for ds in "${datasets[@]}"; do
  ...
  out_dir="fyp/results/imc/${ds}/cache_sim/source_seen"
  ...
  plot_cmd=(python3 fyp/scripts/plot_cache_capacity.py "$capacity_csv" --out-dir "$dataset_plots_dir" --prefix "imc_${ds}_source_seen_capacity" --min-capacity "$CAPACITY_PLOT_MIN_CAPACITY")
...
echo "Done. IMC source-seen CSVs under fyp/results/imc/{uni1,uni2}/cache_sim/source_seen"
