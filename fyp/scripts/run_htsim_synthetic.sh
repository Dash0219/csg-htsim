...
print_usage() {
  cat <<'EOF'
Usage:
  bash fyp/scripts/run_htsim_synthetic.sh [options]
...
# Stdout progress/debug output is written to fyp/results/synthetic/<protocol>/raw_logs/*.raw.log.
# Connection matrices are shared across protocols under fyp/results/synthetic/shared/connection_matrices/.
# Output files are written to:
#   fyp/dataset/synthetic/<protocol>/log_incast_mono.txt
#   fyp/dataset/synthetic/<protocol>/log_a2a_mono.txt
#   fyp/dataset/synthetic/<protocol>/log_incast_bimodal.txt
#   fyp/dataset/synthetic/<protocol>/log_a2a_bimodal.txt
#   fyp/dataset/synthetic/<protocol>/log_incast_pareto.txt
#   fyp/dataset/synthetic/<protocol>/log_a2a_pareto.txt
#   fyp/dataset/synthetic/<protocol>/log_incast_exponential_skewed.txt
#   fyp/dataset/synthetic/<protocol>/log_a2a_exponential_skewed.txt
# Optional temporal-locality variants:
#   fyp/dataset/synthetic/<protocol>/log_<pattern>_temp_<multiplier>.txt
...
CM_DIR="${CM_DIR:-fyp/results/synthetic/shared/connection_matrices}"
mkdir -p "$CM_DIR"
...
for PROTOCOL in $PROTOCOLS; do
  ...
  OUT_DIR="${OUT_DIR:-fyp/dataset/synthetic/${PROTOCOL}}"
  RUN_DIR="fyp/results/synthetic/${PROTOCOL}/raw_logs"
