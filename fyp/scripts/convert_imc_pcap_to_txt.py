...
Examples:
  # Convert one shard into a .txt next to the input file
        python3 fyp/scripts/convert_imc_pcap_to_txt.py fyp/dataset/imc/uni2/uni2_trace_pcap/uni2_pt1

    # Convert all shards in a dataset folder into an output folder
  python3 fyp/scripts/convert_imc_pcap_to_txt.py \
                        fyp/dataset/imc/uni2/uni2_trace_pcap --output-dir fyp/dataset/imc/uni2/uni2_trace_txt

  # Convert directory and also write one merged TSV file
  python3 fyp/scripts/convert_imc_pcap_to_txt.py \
                        fyp/dataset/imc/uni2/uni2_trace_pcap \
                        --output-dir fyp/dataset/imc/uni2/uni2_trace_txt \
                        --merged-output fyp/dataset/imc/uni2/uni2_trace_all.txt
"""
