...
def main():
    ...
    ap.add_argument("--logs-dir", default="fyp/dataset/synthetic", help="Directory containing log_<dataset>.txt files")
    ap.add_argument("--out-dir", default="fyp/results/synthetic/flow_size/plots", help="Output directory for figures")
