...
print_usage() {
  cat <<'EOF'
Usage:
  bash fyp/scripts/run_plot_flow_lifetime_mawi_top8.sh [options]

Options:
  -s, --split-dir DIR        Input split directory (default: fyp/dataset/mawi/mawi_sinks_top8_prefix16)
  -o, --out-dir DIR          Output directory (default: fyp/results/mawi/flow_lifetime/plots)
...
OUT_DIR="${OUT_DIR:-fyp/results/mawi/flow_lifetime/plots}"
