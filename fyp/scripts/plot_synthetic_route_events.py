...
Usage:
  python3 fyp/scripts/plot_synthetic_route_events.py \
        fyp/results/synthetic/cache_sim/route_changes/results_synthetic_incast_mono.csv \
      --out-dir fyp/results/synthetic/cache_sim/route_changes/plots

  python3 fyp/scripts/plot_synthetic_route_events.py \
        fyp/results/synthetic/cache_sim/route_changes/results_synthetic_*.csv \
      --out-dir fyp/results/synthetic/cache_sim/route_changes/plots --show

    # Use built-in synthetic defaults (incast_mono, a2a_mono, and paired
    # distribution variants with incast_/a2a_ prefixes)
    python3 fyp/scripts/plot_synthetic_route_events.py --use-defaults --out-dir fyp/results/synthetic/cache_sim/route_changes/plots
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
            "--out-dir",
            default="fyp/results/synthetic/cache_sim/route_changes/plots",
    ...
    parser.add_argument(
        "--use-defaults",
        action="store_true",
        help="Plot the default synthetic route-change CSV set under fyp/results/synthetic/cache_sim/route_changes",
    )
    return parser.parse_args()


def default_synthetic_csvs() -> List[Path]:
    root = Path("fyp/results/synthetic/cache_sim/route_changes")
