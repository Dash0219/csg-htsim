...
Usage:
  python3 fyp/scripts/flow_stats.py <logfile> [<logfile> ...] [--top N] [--csv FILE] [--hist]
    python3 fyp/scripts/flow_stats.py --use-defaults [--top 10]
...
def default_synthetic_logs(include_low_temp=False):
    base = [
        "fyp/dataset/synthetic/log_incast_mono.txt",
        "fyp/dataset/synthetic/log_a2a_mono.txt",
        "fyp/dataset/synthetic/log_incast_bimodal.txt",
        "fyp/dataset/synthetic/log_a2a_bimodal.txt",
        "fyp/dataset/synthetic/log_incast_pareto.txt",
        "fyp/dataset/synthetic/log_a2a_pareto.txt",
        "fyp/dataset/synthetic/log_incast_heavytail.txt",
        "fyp/dataset/synthetic/log_a2a_heavytail.txt",
        "fyp/dataset/synthetic/log_incast_exponential_skewed.txt",
        "fyp/dataset/synthetic/log_a2a_exponential_skewed.txt",
    ]
    if include_low_temp:
...
def main():
    ...
    ap.add_argument(
        "--use-defaults",
        action="store_true",
        help="Analyze built-in synthetic logs under fyp/dataset/synthetic",
    )
    ap.add_argument(
        "--synthetic-defaults",
        action="store_true",
