...
try:
    from fyp.scripts.plot_flow_concurrency import (
...
def parse_args():
    ...
    ap.add_argument("--out-dir", default="fyp/results/imc/uni2/flow_concurrency/plots", help="Output directory for PNGs")
...
def default_imc_logs():
    files = []
    for ds in ("uni1", "uni2"):
        split_dir = os.path.join("fyp", "dataset", "imc", ds, f"{ds}_sinks_top8_prefix16")
