...
Examples:
  # Convert one shard into a .txt next to the input file
        python3 dash_scripts/convert_imc_pcap_to_txt.py dash_dataset/imc/univ2/univ2_trace_pcap/univ2_pt1

    # Convert all shards in a dataset folder into an output folder
  python3 dash_scripts/convert_imc_pcap_to_txt.py \
                        dash_dataset/imc/univ2/univ2_trace_pcap --output-dir dash_dataset/imc/univ2/univ2_trace_txt

  # Convert directory and also write one merged TSV file
  python3 dash_scripts/convert_imc_pcap_to_txt.py \
                        dash_dataset/imc/univ2/univ2_trace_pcap \
                        --output-dir dash_dataset/imc/univ2/univ2_trace_txt \
                        --merged-output dash_dataset/imc/univ2/univ2_trace_all.txt
"""
