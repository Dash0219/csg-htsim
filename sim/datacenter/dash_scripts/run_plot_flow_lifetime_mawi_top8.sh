...
print_usage() {
  cat <<'EOF'
Usage:
  bash dash_scripts/run_plot_flow_lifetime_mawi_top8.sh [options]

Options:
  -s, --split-dir DIR        Input split directory (default: dash_dataset/mawi/mawi_sinks_top8_prefix16)
  -o, --out-dir DIR          Output directory (default: dash_results/mawi/flow_lifetime/plots)
...
OUT_DIR="${OUT_DIR:-dash_results/mawi/flow_lifetime/plots}"
