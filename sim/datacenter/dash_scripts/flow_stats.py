...
Usage:
  python3 dash_scripts/flow_stats.py <logfile> [<logfile> ...] [--top N] [--csv FILE] [--hist]
    python3 dash_scripts/flow_stats.py --use-defaults [--top 10]
...
def main():
    ...
    ap.add_argument(
        "--use-defaults",
        action="store_true",
        help="Analyze built-in synthetic logs under dash_dataset/synthetic",
    )
    ap.add_argument(
        "--synthetic-defaults",
        action="store_true",
